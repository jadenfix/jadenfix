...
- **Predictive Stochastic Modeling for Financial Markets**  
  ...
  View it [here](https://github.com/jadenfix/Predictive-Stochastic-Modeling-for-Financial-Markets-?tab=readme-ov-file).

- **Natural Language Processing Projects**  
  Discover my work in NLP, where I experiment with innovative approaches and models.  
  Browse the projects [here](https://github.com/jadenfix/NLP).

- **Bayesian Neural Network for CIFAR-10**  
  Explore my project on image classification using Bayesian neural networks.  
  Find out more [here](https://github.com/jadenfix/Bayesian-Neural-Network-for-CIFAR-10-Image-Classification).

- **Other Repositories**  
  See all of my work on my [GitHub repositories](https://github.com/jadenfix?tab=repositories).
...
## Resume & Availability
- **Resume:** View my [updated resume](https://github.com/jadenfix/resume/blob/main/Resume%20-%20Jaden%20Fix.pdf).  
